...
map.getView().fit([-12946417.114509, 7438722.044301, -12909609.450066, 7461094.357863], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">AMP - SUCKER CREEK FIRST NATION</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (403 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'The Sucker Creek First Nation Asset Management Webmap serves as a pivotal tool for the effective administration of community resources. This interactive map amalgamates asset data from three essential sources: detailed field surveys, insightful community contributions, and reliable open-source data. It provides a comprehensive overview of infrastructure, including buildings, driveways, roadways, etc.';
            }
